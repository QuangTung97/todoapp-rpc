...
func (m *TodoGetRequest) GetType() v1.TodoType {
	if m != nil {
		return m.Type
	}
...
var fileDescriptor_576f159e2510ba3a = []byte{
	...
	,
}
...
func (m *TodoGetRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Type != 0 {
		i = encodeVarintTodoapp(dAtA, i, uint64(m.Type))
		i--
		dAtA[i] = 0x8
	}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= v1.TodoType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
